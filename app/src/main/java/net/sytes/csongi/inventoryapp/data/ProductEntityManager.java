...
public class ProductEntityManager {
    ...
    public List<ProductEntity> findProductsBySupplierName(String supplierName) {
        return null;
    }
    ...
    public List<Long> insertProduct(ProductEntity productEntity) {
        ...
        if (resultList.isEmpty()) {
            ...
            contentValues.put(ProductContract.ProductEntry.COLUMN_NAME_PRODUCT_NAME, productEntity.getProductName());
            contentValues.put(ProductContract.ProductEntry.COLUMN_NAME_PRICE, productEntity.getPrice());
            contentValues.put(ProductContract.ProductEntry.COLUMN_NAME_QUANTITY, productEntity.getQuantity());
            contentValues.put(ProductContract.ProductEntry.COLUMN_NAME_SUPPLIER_NAME, productEntity.getSupplierName());
            contentValues.put(ProductContract.ProductEntry.COLUMN_NAME_SUPPLIER_PHONE, productEntity.getSupplierPhone());

            ProductDbHelper helper = new ProductDbHelper(mContext);
            SQLiteDatabase database = helper.getWritableDatabase();
            Long result = database.insert(ProductContract.ProductEntry.TABLE_NAME, null, contentValues);
